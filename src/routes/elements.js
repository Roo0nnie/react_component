...
// MY ROUTE
export const MyDashBoard = Loadable(lazy(() => import('../quinsayas-modules/qm')));
export const SONGS = Loadable(lazy(() => import('../quinsayas-modules/Mae')));
...
export const Rating = Loadable(lazy(() => import('../pages/dashboard/RatingPage')));
export const Select = Loadable(lazy(() => import('../pages/dashboard/SelectPage')));
export const Slider = Loadable(lazy(() => import('../pages/dashboard/SliderPage')));
export const Switch = Loadable(lazy(() => import('../pages/dashboard/SwitchPage')));
export const TextField = Loadable(lazy(() => import('../pages/dashboard/TextFieldPage')));
export const TransferList = Loadable(lazy(() => import('../pages/dashboard/TransferListPage')));
export const ToggleButton = Loadable(lazy(() => import('../pages/dashboard/ToggleButton')));
export const Avatar = Loadable(lazy(() => import('../pages/dashboard/AvatarPage')));
export const Badge = Loadable(lazy(() => import('../pages/dashboard/BadgePage')));
export const Chip = Loadable(lazy(() => import('../pages/dashboard/ChipPapge')));
export const Divider = Loadable(lazy(() => import('../pages/dashboard/DividerPage')));
export const Icon = Loadable(lazy(() => import('../pages/dashboard/IconsPage')));
export const MaterialIcon = Loadable(lazy(() => import('../pages/dashboard/MaterialIconPage')));
export const List = Loadable(lazy(() => import('../pages/dashboard/ListPage')));
export const Table = Loadable(lazy(() => import('../pages/dashboard/TablePage')));
export const Tooltip = Loadable(lazy(() => import('../pages/dashboard/TooltipPage')));
export const Typography = Loadable(lazy(() => import('../pages/dashboard/TypographyPage')));
export const Alert = Loadable(lazy(() => import('../pages/dashboard/AlertPage')));
export const Backdrop = Loadable(lazy(() => import('../pages/dashboard/BackdropPage')));
export const Dialog = Loadable(lazy(() => import('../pages/dashboard/DialogPage')));
export const Progress = Loadable(lazy(() => import('../pages/dashboard/ProgressPage')));
export const Skeleton = Loadable(lazy(() => import('../pages/dashboard/SkeletonPage')));
export const Snackbar = Loadable(lazy(() => import('../pages/dashboard/SnackbarPage')));
export const Accordion = Loadable(lazy(() => import('../pages/dashboard/AccordionPage')));
export const Appbar = Loadable(lazy(() => import('../pages/dashboard/AppbarPage')));
export const Card = Loadable(lazy(() => import('../pages/dashboard/CardPage')));
export const Paper = Loadable(lazy(() => import('../pages/dashboard/PaperPage')));
export const BottomNavigation = Loadable(lazy(() => import('../pages/dashboard/BottomNavigationPage')));
export const Breadcrumbs = Loadable(lazy(() => import('../pages/dashboard/BreadcrumbsPage')));
export const Drawer = Loadable(lazy(() => import('../pages/dashboard/DrawerPage')));
export const Link = Loadable(lazy(() => import('../pages/dashboard/LinkPage')));
export const Menu = Loadable(lazy(() => import('../pages/dashboard/MenuPage')));
export const Pagination = Loadable(lazy(() => import('../pages/dashboard/PaginationPage')));
export const SpeedDial = Loadable(lazy(() => import('../pages/dashboard/SpeedDialPage')));
export const Stepper = Loadable(lazy(() => import('../pages/dashboard/StepperPage')));
export const Tab = Loadable(lazy(() => import('../pages/dashboard/TabPage')));
