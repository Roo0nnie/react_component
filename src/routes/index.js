  ...
  return useRoutes([
    ...
    // Dashboard
    {
      ...
      children: [
        ...
        // My route
        { path: 'quinsayas-dashboard', element: <MyDashBoard /> },
        { path: 'Ibong-favsongs', element: <SONGS /> },
        { path: 'autocomplete', element: <GeneralAppPage /> },
        { path: 'button', element: <GeneralEcommercePage /> },
        { path: 'button-group', element: <GeneralAnalyticsPage /> },
        { path: 'checkbox', element: <GeneralBankingPage /> },
        { path: 'floating-action', element: <GeneralBookingPage /> },
        { path: 'radio-button', element: <GeneralFilePage /> },
        ...
        { path: 'material-icon', element: <MaterialIcon /> },
